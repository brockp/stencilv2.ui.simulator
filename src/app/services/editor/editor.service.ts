...
export class EditorService {
  ...
  public loadDynamicHeadline(headline: any): FormGroup {
    return this.fb.group({
      ...
      h1: this.fb.group({
        ...
        Padding: this.fb.group({
          top: headline.Padding.top || 0,
          right: headline.Padding.right || 0,
          bottom: headline.Padding.bottom || 0,
          left: headline.Padding.left || 0,
        }),
      }),
      h2: this.fb.group({
        Text: '',
  ...
  // Get & Load expandingText Component
  /////////////////////////////////////////////////
  public createCarousel(carousel: any): FormGroup {
    return this.fb.group({
      id: 1,
      component: 'carousel',
      TextAlignment: '',
  ...
  public loadCaroursel(carousel: any): FormGroup {
    return this.fb.group({
      ...
      carousel: this.fb.group({
        ...
        Loop: carousel.Loop,
        BounceEnabled: carousel.BounceEnabled,
        OverMoveCommandName: carousel.OverMoveCommandName,
